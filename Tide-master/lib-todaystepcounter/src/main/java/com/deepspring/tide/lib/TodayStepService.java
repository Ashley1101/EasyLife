...
import com.deepspring.tide.lib.DateUtils;
...
import com.deepspring.tide.lib.R;
import com.deepspring.tide.lib.TodayStepCounter;
import com.deepspring.tide.lib.TodayStepDBHelper;
import com.deepspring.tide.lib.WakeLockUtils;
import com.deepspring.tide.lib.ITodayStepDBHelper;
import com.deepspring.tide.lib.ITodayStepDBHelper;
import com.deepspring.tide.lib.OnStepCounterListener;
import com.deepspring.tide.lib.R;
import com.deepspring.tide.lib.SportStepJsonUtils;
import com.deepspring.tide.lib.StepUtil;
import com.deepspring.tide.lib.TodayStepCounter;
import com.deepspring.tide.lib.TodayStepDBHelper;
import com.deepspring.tide.lib.TodayStepData;
import com.deepspring.tide.lib.TodayStepDetector;
import com.deepspring.tide.lib.WakeLockUtils;
...
import static com.deepspring.tide.lib.SportStepJsonUtils.getCalorieByStep;
import static com.deepspring.tide.lib.SportStepJsonUtils.getDistanceByStep;
...
public class TodayStepService extends Service implements Handler.Callback {
    ...
    private final ISportIBinder mIBinder = new ISportIBinder();
...
//        JLogger.i(TAG, "onStartCommand CurrStep :" + CURRENT_STEP + "   mSeparate:" + mSeparate + "    mBoot:" + mBoot);
    ...
    public IBinder onBind(Intent intent) {
        Log.d(TAG,"onBind : CurrStep : " + CURRENT_STEP);
        Map<String, String> map = getLogMap();
        map.put("current_step", String.valueOf(CURRENT_STEP));
...
//        JLogger.i(TAG, "cleanDb");
    ...
    private class ISportIBinder extends ISportStepInterface.Stub{
